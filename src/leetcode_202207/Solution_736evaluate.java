 ...
 * @author: fanghao
 * @create: 2022-07-06 10:14
 *
 * expression = "(let x 2 (mult x (let x 3 y 4 (add x y))))"
 **/

public class Solution_736evaluate {
    ...
    public static void main(String[] args) {
        ...
        Solution_736evaluate solution_736evaluate = new Solution_736evaluate();
        System.out.println(solution_736evaluate.evaluate(expression));
    }
}
